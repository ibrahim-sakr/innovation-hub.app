        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="inner text-center">
                    <h3 class="title color-white mb--50">Build Best Educational Sites <br> with EduVibe HTML
                        Template </h3>
                    <div class="button-group">
                        <a class="edu-btn purchase-btn" href="https://1.envato.market/VyeWkO" target="_blank">Get
                            EduVibe <i class="icon-arrow-right-line-right"></i>
                        </a>
        ...
        <div class="work-shop d-xl-block d-none">
            <div class="inner">
                ...
                <div class="content">
                    ...
                    <div>
                        <a class="edu-btn btn-secondary btn-small" href="#">Join Now <i
                                class="icon-arrow-right-line-right"></i>
                        </a>
                    </div>
                </div>
