(function (window, document, $, undefined) {
    ...
    if (typeof formQuestions !== 'undefined') {
        // slide
        const countQuestions = Object.keys(formQuestions).length
        const step = (100 / countQuestions).toFixed(0)

        formQuestions.forEach((question, index) => {
            composer[question.type](question.slug, {
